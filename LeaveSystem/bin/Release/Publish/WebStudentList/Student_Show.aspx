<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student_Show.aspx.cs" Inherits="LeaveSystem.WebStudentList.Student_Show" %>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
     ...
     <div class="col-sm-8">
        ...
        <div class="form-group row">
         <asp:Button ID="Xiu"  runat="server" class="btn btn-primary mx-auto" Text="修改档案" onclick="Xiu_Click" /> <!-- mx-auto 居中-->
            </div>
    </div>
    ...
    <asp:Repeater ID="Liebiao" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                    <a href="Student_vacationShow.aspx?number=<%#Eval("Number") %>" class="red">查看</a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
