<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhuye.aspx.cs" Inherits="LeaveSystem.WebList.Zhuye" %>
...
<main>
  ...
  <hr class="my-4">
  <p class="text-danger">😀请及时查看是否有未审批请假条！</p>
   <p class="text-danger">您有 <asp:Label ID="Count" runat="server"></asp:Label> 条假条未审批！请尽快处理。</p>
  </div>
